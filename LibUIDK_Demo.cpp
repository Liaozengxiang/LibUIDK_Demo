// LibUIDK_Demo.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CLibUIDK_DemoApp, CWinApp)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CLibUIDK_DemoApp construction

CLibUIDK_DemoApp::CLibUIDK_DemoApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CLibUIDK_DemoApp object

CLibUIDK_DemoApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CLibUIDK_DemoApp initialization

BOOL CLibUIDK_DemoApp::InitInstance()
{
	...
	if (CUIMgr::SetUIPath(_T("Skins\\LibUIDK_Demo\\the.xui")) != 0)
	{
...
int CLibUIDK_DemoApp::ExitInstance() 
{
	if (m_pFrame != NULL)
	{
		delete m_pFrame;
...
/////////////////////////////////////////////////////////////////////////////
// CLibUIDK_DemoApp message handlers
